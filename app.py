...
# -------------------------
# LOAD DATA (FINAL WORKING VERSION)
# -------------------------
@st.cache_data
def load_prices():
    df = yf.download(
    ...
    # 🔥 CRITICAL FIX: DO NOT REINDEX / DO NOT CREATE FAKE DAYS
    # Only forward fill existing trading days
    close = close.ffill()
...
for asset in portfolio:
    ...
    # STRICT: ONLY USE PAST AVAILABLE DATA
    s = s[s.index <= d]
